...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_ilac_downtown_campus).setOnClickListener {
            findViewById<View>(R.id.map_fragment_container).visibility = View.VISIBLE
        ...
        findViewById<Button>(R.id.btn_connect_ilac_and_my_location).setOnClickListener {
            findViewById<View>(R.id.map_fragment_container).visibility = View.VISIBLE
            if (::map.isInitialized) {
                pendingAction = {
